...
int main()  {
    ...
    const double W0=-870e-4;
    const double Tw0=0.445;

    const double W1=902e-4;	
    const double Tw1=0.342;
    const double Uin1=0.0445;

    const double W2=1068e-4;
    const double Tw2=0.313;
    const double Uin2=0.0965;

    const double W3=Notae-4;		
    const double Tw3=Nota;
    const double Uin3=0.1252;
    return 0;
}